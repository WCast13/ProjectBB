...
class ParksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create park" do
    assert_difference('Park.count') do
      post parks_url, params: { park: { address: @park.address, city: @park.city, manager_name: @park.manager_name, name: @park.name, state: @park.state, zip_code: @park.zip_code } }
    end
  ...
  test "should update park" do
    patch park_url(@park), params: { park: { address: @park.address, city: @park.city, manager_name: @park.manager_name, name: @park.name, state: @park.state, zip_code: @park.zip_code } }
