...
class ResidentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resident" do
    assert_difference('Resident.count') do
      post residents_url, params: { resident: { address: @resident.address, city: @resident.city, lot_number: @resident.lot_number, resident-one: @resident.resident-one, resident-twtwo: @resident.resident-twtwo, state: @resident.state, zipcode: @resident.zipcode } }
    end
  ...
  test "should update resident" do
    patch resident_url(@resident), params: { resident: { address: @resident.address, city: @resident.city, lot_number: @resident.lot_number, resident-one: @resident.resident-one, resident-twtwo: @resident.resident-twtwo, state: @resident.state, zipcode: @resident.zipcode } }
